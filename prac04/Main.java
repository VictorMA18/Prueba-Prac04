...
public class Main extends Application{
    ...
    public void start(Stage primaryStage) {
        ...
        // Cargar la imagen
        Image backgroundImage = new Image(getClass().getResourceAsStream("/Img/Portada.jpg"));

        // Crear un ImageView con la imagen
        ImageView backgroundImageView = new ImageView(backgroundImage);

        // Ajustar el tamaño preferido del StackPane para que coincida con el tamaño de la imagen
